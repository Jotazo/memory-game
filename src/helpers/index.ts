export { default as checkHasPairClicked } from "./checkHasPairClicked";
export { default as checkHowManyClicks } from "./checkHowManyClicks";
export { default as getFoundedItem } from "./getFoundedItem";
