...
const BabyCarriageIcon: React.FC<SVGProps> = ({ customClasses }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={`icon icon-tabler icon-tabler-baby-carriage md:w-[99px] ${customClasses}`}
      width="58"
      height="58"
      viewBox="0 0 24 24"
      strokeWidth="2"
    ...
    >
      ...
      <path d="M8 19m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0"></path>
